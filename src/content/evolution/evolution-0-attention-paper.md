...
![注意力机制的本质]( /images/evolution-0-attention-paper/95eaa237.jpg "图1：注意力机制——Query、Key、Value")
...
![O(N²) 复杂度暴增]( /images/evolution-0-attention-paper/76fdb834.jpg "图2：序列长度增加，计算量以平方速度爆炸")
